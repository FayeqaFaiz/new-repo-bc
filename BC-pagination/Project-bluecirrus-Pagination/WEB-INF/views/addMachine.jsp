    ...
    <div id="maincontent" class="span8"> 
      ...
      <form id="registration-form" class="form-horizontal">
          ...
          <div class="form-control-group">
            ...
            <div class="form-control-group">
            <label class="control-label" for="SYS_FAMILY">"SYS_FAMILY"</label>
            <div class="controls">
              <input type="text" class="input-xlarge" name=""SYS_FAMILY"" id=""SYS_FAMILY"">
            </div>
          </div>
	...
	<thread>
		...
		<tbody>
			<tr>
				...
				<td><c:out value="${machine.SYS_FAMILY}"/></td>
